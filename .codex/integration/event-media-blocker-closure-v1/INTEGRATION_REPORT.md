...
|---|---|---|---|---|---|---|
| L0 | R02 | `normalization/event-media-blocker-closure-v1` | in progress | `e04d364` | integrator | Draft PR #33 open; final receipt/CI pending |
...
| L5 | R08 | `agent/event-media-blocker-closure-v1/validation` | in progress | — | pending | strict schemas, receipt builder, mutations, workflow bridge |
