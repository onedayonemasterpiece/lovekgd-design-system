...
|---|---|---|---|---|
| `action-map-design` | R05 | `e46eb71daf1cf8726cf540b92fef86a577e65c2f` | merged with one rejected hunk | four ordered commits integrated; optional root `README.md` and `docs/index.md` routing hunks reverted because both are covered by the immutable Project Normalization Synthesis receipt; canonical Product Atlas/action-map routing remains in the updated Product Atlas contract and in `events-bot-new` indexes/routes |
...
- Immutable Product Normalization Synthesis outputs, including root `README.md` and `docs/index.md`, remain byte-identical.
