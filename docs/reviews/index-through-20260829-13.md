...
| `REV-IDEAHUB-20260829-10` | Incremental fetched history after `eca10ad…` through IdeaHub HEAD `eaac25fda5e31d58e3207ea1a06dd4e79e896560`: 5 voice commits / 5 packets | [`idea-hub-owner-voice-intake-20260829-continuation-10.md`](idea-hub-owner-voice-intake-20260829-continuation-10.md): one LoveKGD fixture-density correction; 4 MCP/IdeaHub packets excluded | new `OV-57` | branch `fix/penpot-owner-comments-20260826`, Draft PR `#53` | `ASTRO_AND_PENPOT_STRUCTURALLY_VERIFIED / VISUAL_EXPORT_BLOCKED` | `NO` |
| `REV-IDEAHUB-20260829-11` | Incremental all-ref fetch after `eaac25f…` through `origin/main` `16b82b2ceadd5c384569ecea0c5a97ae47f91b80`: 4 voice commits / 4 packets | [`idea-hub-owner-voice-intake-20260829-continuation-11.md`](idea-hub-owner-voice-intake-20260829-continuation-11.md): all four concern mobile MCP/IdeaHub/EventsBot architecture and are excluded | no new LoveKGD OV | branch `fix/penpot-owner-comments-20260826`, Draft PR `#53` | `AUDITED / NO_NEW_RELEVANT_PACKET` | `NO` |
| `REV-IDEAHUB-20260829-12` | Incremental all-ref fetch after `16b82b2…` through `origin/main` `78b8aeabc9e3c32b9a2798bbb7e2463f38db762d`: 4 voice commits / 4 packets | [`idea-hub-owner-voice-intake-20260829-continuation-12.md`](idea-hub-owner-voice-intake-20260829-continuation-12.md): terminology/mobile MCP plus Wonderful Lections lecture and presentation workflows; all excluded | no new LoveKGD OV; `OV-57` remains newest relevant packet | branch `fix/penpot-owner-comments-20260826`, Draft PR `#53` | `AUDITED / NO_NEW_RELEVANT_PACKET` | `NO` |
| `REV-IDEAHUB-20260829-13` | Incremental all-ref fetch after `78b8ae…` through `origin/main` `3e9f93187da63ce9c054c57d27a7f1b4c8dd2bbf`: 3 new voice commits / 3 packets | [`idea-hub-owner-voice-intake-20260829-continuation-13.md`](idea-hub-owner-voice-intake-20260829-continuation-13.md): regional audio-guide architecture/business and MCP-security lecture thesis; all excluded | no new LoveKGD OV; `OV-57` remains newest relevant packet | branch `fix/penpot-owner-comments-20260826`, Draft PR `#53` | `AUDITED / NO_NEW_RELEVANT_PACKET` | `NO` |
...
| `OV-08` | глобальный запрет визуально скрытых duplicate component roots | `STRUCTURAL_CORRECTION_ADVANCED / GLOBAL_NONCARD_CENSUS_PENDING` | `NO` | EventCard lineage is now concrete in current owner pages: Date/Weekend consume 5 centralized compact variants; Popular desktop consumes 15 linked `density=popular` masters through 3 linked behavior-group fixtures; Popular mobile remains on canonical Mobile rail; Free collection/Favorites/Home/Search/Festivals/Exhibitions expose linked card ancestry and no visible native card root in the fresh archetype census. Popular receipt: `evidence/recovery-20260829/penpot/popular-listing-event-card-centralization-receipt.v1.json`. Remaining gate is the same census for non-card component families and owner visual acceptance. |
...
| `OV-54` | cross-cutting Penpot tokens for colors, typography, spacing, radii, elevation and sizing | `PENPOT_FOUNDATIONS + FIFTEEN COMPONENT MIGRATION BATCHES / GLOBAL MIGRATION IN_PROGRESS` | `NO` | Page `20` projects the source-conformant foundation set; the current set has `97` tokens. Fifteen bounded migrations now cover Announcements, shared navigation/social-proof/discovery roots, exact-seven Artifact collection/card/owner roots, the responsive Interest Club card, Favorites/Personal Feed owners, Search/Event Detail roots and the canonical Home/Date/Weekend owners. Batches `12–15` bind seventeen owner roots to `radius.20` (`68/68`) through revision `2839`, one settled page at a time; batches `13–15` add Popular, Collections, Exhibitions, Festivals, Interest clubs, Focus group, Information and Special-state factual owners. A new exact census uses the 34 board IDs from executable round-trip bindings: all 34 exist; 24 have a nonzero uniform radius, 23 canonical-ready roots are bound, 0 eligible roots remain, and 1 nonzero root is authority-blocked (Unusual mobile under OV-49); 10 zero-radius roots are explicit non-applicable cases. Search now counts the factual entered-query results owners rather than the obsolete idle-anonymous representatives. Latest census revision is `2839`, geometry is unchanged and `validate()=[]`. The root-token migration is complete for every canonical-ready owner. `space.4`, OV-49 itself (Unusual mobile requires an approved nonempty editorial source) and post-binding visual export remain open. |
| `OV-57` | use bounded versioned fixture pools shared by Astro fixture mode and Penpot; do not copy full production listings into design-system pages | `ASTRO_AND_PENPOT_STRUCTURALLY_VERIFIED / FESTIVAL_CARDS_COMPONENTIZED / VISUAL_EXPORT_BLOCKED` | `NO` | New relevant IdeaHub packet `voice-20260829-072140-eed2c8df` was found at HEAD `eaac25f…` and taken into work. Contract `catalog/reconstruction-atlas/v1/design-system-reference-fixtures-ov57.v1.json` reuses the existing eight-event golden corpus, the exact three factual clubs and the exact-seven Artifact product collection. Astro originally introduced the explicit seven-card `1/4/2` preview profile at `dec0d11b3`; current commit `67197ef3e` additionally routes every Festival item through centralized `FestivalCard.astro`. Penpot revision `2917` has the same seven factual cards in each bounded desktop/mobile owner, all linked from `Event cards / Festival / Context`; the 12 formerly owner-local card boards are replaced, zero remain, and the old all-21 raster owners stay hidden/superseded. Contract: `catalog/reconstruction-atlas/v1/festival-card-centralization-20260829.v1.json`. Structural read-back, round-trip bindings and `validate()=[]` pass. Final raster comparison remains honestly open because the single bounded exporter attempt returned HTTP 504 and was not blindly retried. Dense/full listing validation stays in Astro. |
