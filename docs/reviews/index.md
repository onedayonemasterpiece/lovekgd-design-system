...
| `OV-06` | `63.15 Artifacts`: 7/7 artifacts и none/subset/all expanded, hover/focus, selected-detail states | `READY_FOR_OWNER_REREVIEW` | `NO` | Visual base is the real pre-presentation donor `008839b14598105d1fed5b4e386d6d6f29d93d1f`; current Astro `70d43a87bf7fdfb748ace6218f17befd0613d01a` overlays exact-seven runtime semantics. Page `63.15` now has native donor-based desktop/mobile owners (`1280×2718`, `390×2951`), seven distinct linked `180×250` artifact components per viewport, `detached=0`, `sourceProjectionCount=0`, and `validate()=[]`. Bounded PNG exports passed visual inspection: no blank overlay, all seven visuals present, donor hero/progress/rules hierarchy retained. Named version saved. Receipt: `evidence/recovery-20260828/penpot/artifact-collection-1-owner-exact-seven-receipt.v1.json` |
