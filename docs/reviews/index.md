...
| `REV-IDEAHUB-20260828-08` | Incremental fetched history after `0d61090…` through IdeaHub HEAD `e0760b9927eecf794cb3fcbae02048497eeecb9c`: 5 commits / 5 packets | [`idea-hub-owner-voice-intake-20260828-continuation-08.md`](idea-hub-owner-voice-intake-20260828-continuation-08.md): Event Detail vertical Hero image, parallax/keyboard SoT, terminology correction, transport and related-events continuation | new `OV-55`, `OV-56`; 3 other-project packets excluded | branch `fix/penpot-owner-comments-20260826`, Draft PR `#53` | `CORRECTION_MATERIALIZED / OWNER_REREVIEW_REQUIRED` | `NO` |
...
| `OV-06` | `63.15 Artifacts`: 7/7 artifacts и none/subset/all expanded, hover/focus, selected-detail states | `READY_FOR_OWNER_REREVIEW` | `NO` | Higher-priority owner decision `f5ea5e497` establishes exactly seven owner-counted source files and rejects the stale 5/8/12 models. Astro `49c351873d40a2ea55f0a32837c7376e344d9c17` now has one exact seven-item registry and 0/7, subset, 7/7, keyboard/pointer and per-artifact detail behavior. Page `63.15` has seven native component masters and visible none/subset/all, hover/focus, desktop/mobile selected-detail boards; stale 1/5 boards are hidden and marked superseded. The desktop owner was remeasured against the live Astro route: `1280×1988.390625`, body `1180×1174`, source-sized three-line title with a 19px structural gap before the lead, 4+3 cards and footer at `y=1306.53125`; mobile remains `390×2008`. Both compositions retain seven distinct linked artifact components with `detached=0`, no root overlay and `validate()=[]`; named version saved. The post-correction desktop and mobile exports returned external HTTP `504` and were not blindly retried. Receipt: `evidence/recovery-20260828/penpot/artifact-collection-1-owner-exact-seven-receipt.v1.json` |
...
| `OV-54` | cross-cutting Penpot tokens for colors, typography, spacing, radii, elevation and sizing | `PENPOT_FOUNDATIONS + BRANDING COMPONENT PILOT / GLOBAL MIGRATION IN_PROGRESS` | `NO` | Page `20` projects the 94-token foundation pilot and 70 bound shapes; revision `2656` extends the catalog to 96 and binds four exact properties on canonical Announcements masters. Ten/eleven gap tokens read back; `space.4` is an external Plugin API defect, global component coverage and post-binding visual export remain open |
