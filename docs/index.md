...
| [`asp-production-conveyor-v3/f0-foundation-review-atlas-r2-successors.md`](asp-production-conveyor-v3/f0-foundation-review-atlas-r2-successors.md) | четыре package-local Foundation review Atlas R2 executors, exact tuples/formulas/replay gates | Git-only executable candidates; Atlas evidence gate pending |
