...
console.log(JSON.stringify({state:'F0_COLORS_STATUS_V7_BUNDLE_GENERATED',bytes:Buffer.byteLength(output),sha256:sha256(Buffer.from(output)),source_projection_sha256:data.source_projection_sha256}));
