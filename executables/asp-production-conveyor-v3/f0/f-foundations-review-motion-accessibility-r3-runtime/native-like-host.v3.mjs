...
class Shape extends PluginData {
  constructor(host,type,id){super();this.host=host;this.type=type;this.id=id;this.name='';this.children=[];this.parent=null;this.width=0;this.height=0;this.x=0;this.y=0;this.fills=[];this.strokes=[];this.layoutCell={};}
...
export class NativeLikePenpot {
  ...
  async uploadMediaData(name,blob){this._requireActive();assert.ok(blob.size>0);this.nativeCreates++;const media={id:`media.${++this._counter}`,name,bytes:blob.size,type:blob.type};this.media.push(media);return media;}
}
