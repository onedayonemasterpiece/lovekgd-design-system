...
const INPUT_FILES = ["data.v1.mjs", "execution-tuple.v1.json", "executor.native-like.test.mjs", "executor.v1.mjs", "native-like-host.v1.mjs", "package.v1.json", "regenerate.v1.mjs", "setup.v1.mjs", "spec.v1.json"];
