...
const HARNESS_HEAD = 'ee6f563af73f7262f5e4aa38e2044b25b5139f24';
const HARNESS_TREE = '300d3075424cd7cd1bae9542eea533af855b3a13';
const HARNESS_PATH = 'tests/asp-production-conveyor-v3/d0/d0_plugin_bundle_conformance_v1.mjs';
const LOCAL_SOURCE_PACKAGE_PATH = 'executables/asp-production-conveyor-v3/a0/a0-owner-review-index-direct-plugin-v3/source-inputs/18-owner-review-index.package.v1.json';
const LOCAL_SOURCE_INDEX_PATH = 'executables/asp-production-conveyor-v3/a0/a0-owner-review-index-direct-plugin-v3/source-inputs/owner-review-index.v1.json';
const LOCAL_SOURCE_ADAPTER_PATH = 'executables/asp-production-conveyor-v3/a0/a0-owner-review-index-direct-plugin-v3/source-inputs/owner-review-index-candidate-adapter.v1.json';
...
const embedded = {
  schema: 'kenigevents.d0.a0-owner-review-index-direct-plugin.v3',
  ...
  page: {
    ...
    header_component_path: 'Documentation',
    header_component_name: 'PageHeader',
  },
  census: { rows: atlasRows.length, atlas_page_units: 42, donor_rows_ignored: 45, screenshots: 0, placeholders: 0 },
  protected: {
    minimum_revision: 113,
    free: { page_id: 'c16498cb-b51d-8030-8008-904bd8fc9c53', root_ids: ['313fb1ed-0d5c-8095-8008-9108df52b2ce','313fb1ed-0d5c-8095-8008-912c45090653'], chars: 84033, utf8_bytes: 84034, sha256: '0b00102e348367601fe35de30e06dc22b10883577a22917320955058115fc042' },
...
const packageRecord = {
  schema_version: 'kenigevents.d0.a0-owner-review-index-direct-plugin-package.v3',
  state: 'MAT_PACKAGE_READY_QA_INTEGRATE_GATED',
  package_id: sourcePackage.package_id,
  global: 'D0A0OwnerReviewIndexV3',
  bundle: { path: 'executables/asp-production-conveyor-v3/a0/a0-owner-review-index-direct-plugin-v3/owner-review-index.bundle.js', bytes: bundleBytes.length, sha256: bundleSha },
  ...
  protected_projection: embedded.protected,
  ...
  replay_created: 0,
  harness: { branch: 'agent/d0-plugin-bundle-conformance-v1-20260902', head: HARNESS_HEAD, tree: HARNESS_TREE, source_path: HARNESS_PATH, local_exact_mirror: 'executables/asp-production-conveyor-v3/a0/a0-owner-review-index-direct-plugin-v3/test-deps/d0_plugin_bundle_conformance_v1.mjs', bytes: localHarnessBytes.length, sha256: sha256(localHarnessBytes) },
  ...
  native_runtime_contract: { supersedes_head: '0538d24a9b7b1550d0f243982300d063800d4f96', repair_comment: 5510849602, harness_comment: 5510837575, portable_sha256: true, text_encoder_required: false, crypto_subtle_required: false, revision_source: 'currentFile.revn', revision_alias: 'FORBIDDEN', active_revision_parity: 'EXACT', missing_or_conflicting_revision: 'FAIL_BEFORE_CREATE' },
