# A0 Owner Review Index direct plugin bundle v3
...
- Conformance harness: `agent/d0-plugin-bundle-conformance-v1-20260902@ee6f563af73f7262f5e4aa38e2044b25b5139f24`
...
use global `D0A0OwnerReviewIndexV3`:
...
V3 uses a portable in-bundle UTF-8/SHA-256 implementation (no `TextEncoder` or
