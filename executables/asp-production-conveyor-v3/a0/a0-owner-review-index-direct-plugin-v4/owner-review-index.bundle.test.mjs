...
function loadBundle() {
  ...
  return sandbox.D0A0OwnerReviewIndexV4;
}
...
test('exact source and Atlas R2 binding are preserved', async () => {
  ...
  assert.equal(packageRecord.harness.head, '5b6341abdcb85d7251262b6ec7fba46277be69f1');
  assert.equal(packageRecord.harness.tree, 'dc1335338be90aaafaf7b57a9d4327630ca5a0c6');
