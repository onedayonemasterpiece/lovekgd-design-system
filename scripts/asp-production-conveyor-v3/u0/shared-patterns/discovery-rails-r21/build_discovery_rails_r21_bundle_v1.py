...
data={'unit':unit,'component':component,'specimens':{k:native['specimens'][k] for k in unit['specimen_ids']},'source':source['source_authority'],'sourceLineage':source['component_source_lineage'][unit['component_ids'][0]],'atlas':{'head':'be4918e5d8e1c1bba5da478acfd08f8035cfc1a5','tree':'da1f5c305c75d467af5e4e26f8a996b8c243d74f','pageOrder':'0230.007','pageId':'shared-pattern-discovery-rails-r2-1','template':'COMPONENT_STATE_GRID_V2','semanticSlots':{'header':'page_header','master_column':'package_owned_masters','state_grid':'linked_state_instances'}}}
