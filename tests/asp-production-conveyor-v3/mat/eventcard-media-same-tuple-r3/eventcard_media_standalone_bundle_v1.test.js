...
const sandbox = { structuredClone, console, Uint8Array, ArrayBuffer, DataView };
sandbox.globalThis = sandbox; vm.createContext(sandbox); vm.runInContext(BUNDLE_SOURCE, sandbox, { filename:BUNDLE });
const API = sandbox.KenigEventsD0EventcardMediaR3Bundle;
...
class Fixture {
  ...
  authorize(projection) {
    ...
    const authorization = { schema: R.AUTH_SCHEMA, packageId: M.PACKAGE_ID, parentPackageId: M.PARENT_PACKAGE_ID,
      ...
      authorityScope: R.AUTHORITY_SCOPE, triggeredBy: provenance.triggeredBy, provenance, bundleSha256: BUNDLE_SHA, bundleBytes: BUNDLE_BYTES };
