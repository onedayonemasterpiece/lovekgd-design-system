...
} = require('../../../../scripts/asp-production-conveyor-v3/f0/typography-layout-r4/type_scale_small_page_atlas_r2.js');
...
test('package executor loads in a plugin-like browser global without CommonJS', () => {
  ...
  vm.runInNewContext(
    readFileSync('scripts/asp-production-conveyor-v3/f0/typography-layout-r4/type_scale_small_page_atlas_r2.js', 'utf8'),
    context,
  );
  assert.equal(
