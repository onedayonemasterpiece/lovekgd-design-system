...
const visualParentProxy=sharedShape({id:partialBoard.id});const partialVisual=sharedShape({id:'313fb1ed-0d5c-8095-8008-91834928ee42',name:'Value visual',width:80.0000011920929,height:63.999998569488525,x:1580,y:44,parent:visualParentProxy,fills:[]},{role:'visual'});partialBoard.children=[partialVisual];
const partialLabel=sharedShape({id:'313fb1ed-0d5c-8095-8008-9183493eed4f',name:'Value label',characters:'brand-600  ·  #a54821',fontWeight:'400',parent:labelParentProxy});
...
const exactParentId=partialLabel.parent.id;partialLabel.parent.id='wrong-parent';assert.throws(()=>adapter.f0Rev79Partial(partialPage),/exact orphan contract drift/);partialLabel.parent.id=exactParentId;
