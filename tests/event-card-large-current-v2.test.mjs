...
const eventsRepo=process.env.EVENTS_REPO||'/home/dev/projects/events-bot-new';
const toolingRepo=process.env.EVENTS_TOOLING_REPO||'/home/dev/projects/events-bot-new';
