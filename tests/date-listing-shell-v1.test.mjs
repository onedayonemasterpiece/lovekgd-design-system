...
assert.match(railTrack.known_structural_gap, /owns linked semantic Event summary/);
assert.match(railTrack.known_structural_gap, /Event digest children/);
assert.match(railTrack.known_structural_gap, /three rail media fixture adapters/);
assert.match(railTrack.known_structural_gap, /identity-absent wrapper and outer Like action wrapper remain ordinary/);
