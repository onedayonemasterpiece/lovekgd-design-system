...
test('Golden Event Corpus v1 remains byte-locked and is not silently rewritten by v2', () => {
  const result = spawnSync('git', ['diff', '--exit-code', '0882917a1328607c498d82e4c2a652bbd3df946d', '--', 'catalog/fixtures/ui-reference-events/v1'], { cwd: repo, encoding: 'utf8' });
